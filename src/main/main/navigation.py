...
class Navigation(Node):
    """
    Navigation Node for AUV control
    Handles various navigation tasks and communicates with thrusters system
    """
    ...
    def __init__(self):
        ...
        self.surge_value = 0.0   # -2 to 2, affects forward/backward movement
    ...
    def listener_callback_target(self, msg):
        """Process target information messages from Mission Control"""
    ...
    def listener_callback_yolo(self, msg):
        """Process YOLO detections and update tracking parameters"""
    ...
    def listener_callback_task_command(self, msg):
        """Process task commands from Mission Control"""
        task_name = msg.data
    ...
    def timer_callback_orientation(self):
        """Publish orientation deviations to thrusters at regular intervals"""
    ...
    #####################################################
    # SECTION: TRACKING AND CONTROL UTILITIES
    #####################################################
    
    def update_tracking_parameters(self):
        """Update angle and distance tracking based on latest detections"""
    ...
    def execute_current_task(self):
        """Execute the currently active task using the appropriate handler"""
